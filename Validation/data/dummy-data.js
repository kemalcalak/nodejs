...
async function populate() {
    ...
    if(count == 0) { 
        ...
        const users = await User.bulkCreate([
            ...
            {fullname: "ahmet yılmaz", email: "info@ahmetyilmaz.com", password: await bcrypt.hash("135790", 10)},
        ]);
        ...
        await users[2].addRole(roles[1]);   // moderator => yigitbilgi

        await users[3].addRole(roles[2]);   // guest => ahmetyilmaz
